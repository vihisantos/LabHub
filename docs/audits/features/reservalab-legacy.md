...
| `GET` | `/api/push/tablets/cleanup` | Limpar reservas de tablets canceladas ha mais de 1 mes |
| `GET` | `/api/push/check-all` | Cron agregado: roda todos os checks (inclui tablets_cleanup) |
