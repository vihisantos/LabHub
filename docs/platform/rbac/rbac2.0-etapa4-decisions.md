...
> Regra deste documento: nenhuma ambiguidade é resolvida por suposição; tudo que não
...
> a interpretação **da especificação vigente** (`admin → Admin de Workspace`), que é a que melhor
