  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit} className="mb-4 rounded-xl border border-line bg-card/50 p-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              {form.items.length === 0 && (
                <p className="text-xs text-fg-muted">Nenhum item adicionado.</p>
              )}
      ...
      {templates.length === 0 && !showForm ? (
        ...
        <div className="flex flex-col gap-3">
          {templates.map((t) => (
            <div key={t.id} className="rounded-xl border border-line bg-card/50 p-4 transition-all hover:-translate-y-0.5 hover:shadow-md">
