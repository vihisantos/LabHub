...
export function SyncStatusBadge() {
  ...
  // Atualiza o tempo relativo a cada 15s
  useEffect(() => {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {/* Popover */}
      {open && (
        <div className="absolute right-0 top-full z-50 mt-2 w-72 rounded-xl border border-line bg-card shadow-2xl shadow-black/20">
          {/* Cabeçalho */}
