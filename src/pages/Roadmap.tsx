...
const FEATURES: Feature[] = [
  ...
  { id: 99, cat: 'high', name: 'SLA de Chamados', desc: 'Prazos por prioridade com atraso destacado no dashboard', effort: 'med', done: false },
  { id: 100, cat: 'high', name: 'Inventário com QR e Impressão de Etiquetas', desc: 'Etiquetas nome/série/QR integradas ao inventário geral', effort: 'med', done: false },
  ...
  { id: 102, cat: 'high', name: 'Modo Offline Total com Fila de Operações', desc: 'Todas as ações ficam enfileiradas e sincronizam ao voltar online', effort: 'high', done: false },
  ...
  { id: 107, cat: 'mid', name: 'Sugestão Automática de Reposição', desc: 'Calcular consumo médio e sugerir compra de peças e itens', effort: 'low', done: false },
  { id: 108, cat: 'mid', name: 'Previsão de Consumo de Peças', desc: 'Estimar necessidade futura com base no histórico de uso', effort: 'med', done: false },
  ...
  { id: 110, cat: 'mid', name: 'Feedback do Professor após Resolução', desc: 'Avaliação rápida de satisfação ao encerrar o chamado', effort: 'low', done: false },
  ...
  { id: 116, cat: 'mid', name: 'Backup Automático Agendado', desc: 'Snapshot periódico do workspace com retenção configurável', effort: 'med', done: false },
  ...
  { id: 149, cat: 'low', name: 'Impressão de Relatórios', desc: 'CSS @media print para relatórios e detalhes', effort: 'low', done: false },
