...
const FEATURES: Feature[] = [
  ...
  { id: 4, cat: 'high', name: 'Dashboard com Gráficos', desc: 'Gráficos de barras/pizza, timeline de manutenções (Recharts)', effort: 'med', done: false },
  ...
  { id: 8, cat: 'mid', name: 'Tema Customizável (Cor de Destaque)', desc: 'Seletor de cor primária nas Configurações', effort: 'med', done: false },
  ...
  { id: 42, cat: 'low', name: 'Grade de Horários de Manutenção', desc: 'Calendário com manutenções agendadas', effort: 'med', done: false },
  { id: 43, cat: 'low', name: 'Consolidado de Estoque por Lab', desc: 'Visão de estoque por laboratório', effort: 'med', done: false },
