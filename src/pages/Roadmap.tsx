...
const FEATURES: Feature[] = [
  ...
  { id: 6, cat: 'mid', name: 'Notificações Push', desc: 'Alertas de manutenção e sync via Push API', effort: 'high', done: true },
  ...
  { id: 13, cat: 'mid', name: 'Histórico de Atividades Global', desc: 'Timeline consolidada de todas as ações', effort: 'med', done: true },
  ...
  { id: 22, cat: 'low', name: 'Sync Periódico (Polling)', desc: 'Re-sincronizar a cada 30s via Service Worker', effort: 'med', done: true },
  ...
  { id: 27, cat: 'low', name: 'Gestão de Garantia e Licenças', desc: 'Alertas de vencimento de garantia e software', effort: 'med', done: true },
  ...
  { id: 38, cat: 'low', name: 'Feed de Atividades Global', desc: 'Timeline consolidada com filtros por dia', effort: 'med', done: true },
  ...
  { id: 47, cat: 'low', name: 'Central de Notificações', desc: 'Ícone de sino com badge e lista de alertas', effort: 'high', done: true },
