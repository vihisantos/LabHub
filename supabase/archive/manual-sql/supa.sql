...
CREATE TABLE IF NOT EXISTS pcare.assets (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  "assetTag" TEXT NOT NULL DEFAULT '', "equipmentType" TEXT NOT NULL DEFAULT 'Outro',
  manufacturer TEXT NOT NULL DEFAULT '', model TEXT NOT NULL DEFAULT '', "serialNumber" TEXT NOT NULL DEFAULT '',
  location TEXT NOT NULL DEFAULT '', status TEXT NOT NULL DEFAULT 'available', observations TEXT NOT NULL DEFAULT '',
  technical JSONB NOT NULL DEFAULT '{}'::jsonb, network JSONB NOT NULL DEFAULT '{}'::jsonb,
  "parentAssetId" UUID REFERENCES pcare.assets(id) ON DELETE SET NULL, "childAssetIds" JSONB NOT NULL DEFAULT '[]'::jsonb,
  photos JSONB NOT NULL DEFAULT '[]'::jsonb, "createdAt" TIMESTAMPTZ DEFAULT NOW(), "updatedAt" TIMESTAMPTZ DEFAULT NOW()
);
...
CREATE POLICY "assets_all" ON pcare.assets FOR ALL USING (true) WITH CHECK (true);
